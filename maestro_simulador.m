...
while(true)
    ...
    formatOut = 'dd_mm_yyyy';
    fhoraa=datestr(now,formatOut);
    nombre_archivo=strcat('D:\maestria\semestre13\script tesis completion_con_ruido_mod_simula_auto\resultados\coseno_resul_simula_',fhoraa,'_0_02.txt');
    fid=fopen(nombre_archivo,'a+'); 
    fprintf(fid,cad); 
    fclose(fid);
...
disp('¡Hola olger inicia el proceso de simuacion continua!') %% señal seno a transmitir
while(true)
    cad=  matrix_completion_izma_sd_auto(2,0,var_ruido);
    % tipo_modulacion,senal_mas_ruido,sigma_v
    %   tipo_modulacion=0 seno
    %   tipo_modulacion=1 coseno
    %   tipo_modulacion=2 solo ruido
    ...
    formatOut = 'dd_mm_yyyy';
    fhoraa=datestr(now,formatOut);
    nombre_archivo=strcat('D:\maestria\semestre13\script tesis completion_con_ruido_mod_simula_auto\resultados\ruido_resul_simula_',fhoraa,'_0_03.txt');
    fid=fopen(nombre_archivo,'a+'); 
    fprintf(fid,cad); 
    fclose(fid);
...
disp('¡Hola olger inicia el proceso de simuacion continua!') %% señal seno a transmitir
while(true)
    cad=  matrix_completion_izma_sd_auto(3,1,var_ruido);
    % tipo_modulacion,senal_mas_ruido,sigma_v
    %   tipo_modulacion=0 seno
    %   tipo_modulacion=1 coseno
    %   tipo_modulacion=2 solo ruido
    ...
    formatOut = 'dd_mm_yyyy';
    fhoraa=datestr(now,formatOut);
    nombre_archivo=strcat('D:\maestria\semestre13\script tesis completion_con_ruido_mod_simula_auto\resultados\bpqk_resul_simula_',fhoraa,'_0_04.txt');
    fid=fopen(nombre_archivo,'a+'); 
    fprintf(fid,cad); 
    fclose(fid);
...
disp('¡Hola olger inicia el proceso de simuacion continua!') %% señal seno a transmitir
while(true)
    cad=  matrix_completion_izma_sd_auto(4,1,var_ruido);
    % tipo_modulacion,senal_mas_ruido,sigma_v
    %   tipo_modulacion=0 seno
    %   tipo_modulacion=1 coseno
    %   tipo_modulacion=2 solo ruido
    ...
    formatOut = 'dd_mm_yyyy';
    fhoraa=datestr(now,formatOut);
    nombre_archivo=strcat('D:\maestria\semestre13\script tesis completion_con_ruido_mod_simula_auto\resultados\qpsk_resul_simula_',fhoraa,'_0_05.txt');
    fid=fopen(nombre_archivo,'a+'); 
    fprintf(fid,cad); 
    fclose(fid);
